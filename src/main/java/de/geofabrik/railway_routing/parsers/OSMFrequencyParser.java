...
public class OSMFrequencyParser implements TagParser {
    ...
    private final IntEncodedValue frequencyEnc;

    public OSMFrequencyParser(IntEncodedValue frequencyEnc) {
    ...
    public void handleWayTags(int edgeId, EdgeIntAccess edgeIntAccess, ReaderWay way, IntsRef relationFlags) {
        ...
        try {
            ...
            if (value <= frequencyEnc.getMaxStorableInt() && value >= frequencyEnc.getMinStorableInt()) {
                frequencyEnc.setInt(false, edgeId, edgeIntAccess, value);
            }
